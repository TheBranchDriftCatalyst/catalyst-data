...
class TestRouteAfterMentionValidation:
    def test_accepted_routes_to_extract_propositions(self):
        state = {
            "latest_mention_validation": {"verdict": "valid"},
    ...
    def test_rejected_with_retries_left_routes_to_repair(self):
        state = {
            "latest_mention_validation": {"verdict": "invalid"},
            "mention_retry_count": 1,
            "max_retries": 3,
        }
...
class TestRouteAfterPropositionValidation:
    def test_accepted_routes_to_persist(self):
        state = {
            "latest_proposition_validation": {"verdict": "valid"},
    ...
    def test_rejected_with_retries_left_routes_to_repair(self):
        state = {
            "latest_proposition_validation": {"verdict": "invalid"},
            "proposition_retry_count": 1,
            "max_retries": 3,
        }
