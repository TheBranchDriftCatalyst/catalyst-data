...
# Clean cached artifacts (keeps pipeline-cache and true fixtures):
python tests/benchmark_harness.py --clean
...
| `task bench:clean` | Clean all cached benchmark artifacts |
